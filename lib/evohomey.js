...
module.exports = {
  login: function(user, password, appid, callback) {
    ...
    // to do, toevoegen voor check op access token expiry, indien token nog 30 seconden geldig, dan geen login uitvoeren )
    ...
    var difference = access_token_expires - currentTime;
    if (difference > 30)
    {
